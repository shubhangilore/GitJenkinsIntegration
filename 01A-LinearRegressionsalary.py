# -*- coding: utf-8 -*-
"""
Created on Fri May 21 18:40:07 2021
...
# Read Data 
##############################################################
df = pd.read_csv("C:\PY-ML\Data/slr-salary-data.csv")
...
print('\n*** Scatterplot ***')
plt.figure()
sns.regplot(x='YearsExperience', y='Salary', data=df, color= 'b', scatter_kws={"s": 10})
